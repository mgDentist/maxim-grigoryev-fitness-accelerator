...
var _abonementsToggle = require("./modules/abonements-toggle/abonements-toggle");
var _videoStarter = require("./modules/video-starter/video-starter");
var _sliderFeedback = require("./modules/slider-feedback/slider-feedback");
var _sliderJury = require("./modules/slider-jury/slider-jury");
var _initTabs = require("./vendor/tabs/init-tabs");
var _initAccordion = require("./vendor/accordion/init-accordion");
var _juryAdditionalInfo = require("./modules/jury-addtitional-info/jury-additional-info");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _abonementsToggle.abonementsToggle)();
  (0, _videoStarter.videoStarter)();
  // feedbackSwiper();
  // jurySwiper();
  // sliderItems();
...
},{"./modules/abonements-toggle/abonements-toggle":2,"./modules/form-validate/form":4,"./modules/jury-addtitional-info/jury-additional-info":10,"./modules/modals/init-modals":11,"./modules/slider-feedback/slider-feedback":13,"./modules/slider-jury/slider-jury":14,"./modules/video-starter/video-starter":15,"./utils/ios-vh-fix":18,"./vendor/accordion/init-accordion":21,"./vendor/tabs/init-tabs":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.abonementsToggle = void 0;
var takeNumberfromString = function takeNumberfromString(text) {
  var result = text.match(/\d+/);
  return result ? result[0] : null;
};
var abonementsToggle = exports.abonementsToggle = function abonementsToggle() {
  document.querySelectorAll('.months__button').forEach(function (button) {
    button.addEventListener('click', function (evt) {
      document.querySelectorAll('.months__item').forEach(function (item) {
        item.classList.remove('months__item--active');
      });
      var parentItem = button.closest('.months__item');
      if (parentItem) {
        parentItem.classList.add('months__item--active');
      }
      var amount = takeNumberfromString(evt.target.textContent);
      document.querySelectorAll('[data-month]').forEach(function (span) {
...
exports.sliderItems = void 0;
var sliderItems = exports.sliderItems = document.querySelectorAll('.slider__item');
sliderItems.forEach(function (item) {
  item.addEventListener('touchstart', function () {
    var additionalInfo = item.querySelector('.slider-additional-info');
    var textElement = item.querySelector('.slider__text');
...
exports.feedbackSwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var feedbackSwiper = exports.feedbackSwiper = new _swiper.default('.feedback__slider-wrapper', {
  initialSlide: 0,
  slidesPerView: 1,
  spaceBetween: 0,
  navigation: {
...
exports.jurySwiper = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var jurySwiper = exports.jurySwiper = new _swiper.default('.slider', {
  navigation: {
...
exports.videoStarter = void 0;
var videoStarter = exports.videoStarter = function videoStarter() {
  var buttonPlay = document.querySelector('.gym__button');
  if (buttonPlay) {
    buttonPlay.addEventListener('click', function () {
      var poster = document.querySelector('.gym__img-video-poster');
      if (poster) {
        poster.style.display = 'none';
      }
      var myIframe = document.querySelector('.gym__video');
      var src = myIframe.src;
      myIframe.src = src.includes('?') ? "".concat(src, "&autoplay=1") : "".concat(src, "?autoplay=1");
...
},{"../../vendor/accordion/accordions":20}],22:[function(require,module,exports){
...
},{"../../vendor/tabs/tabs.js":24}],24:[function(require,module,exports){
"use strict";
